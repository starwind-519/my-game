...
const introTexts = [
  `<p>——2114年。</p>
   <p>那一年，世界在七十二小时内坍塌。街道被火光撕裂，天空像被扯破的幕布，城市被浓烟吞噬，生灵涂炭。</p>
   <p>人们称它为“病毒”，称它为“末日”。可那只是个名字——真正的终章，是人开始变得不再像人，失去了道德与限制。</p>
   <p>我叫<span class='sakiko-text'>丰川祥子</span>。曾经是丰川家的继承人。</p>
   <p>现在——只是尽力在末世里活着的人。</p>`,

  `<p>——那场高烧几乎把我带走。</p>
   <p>我以为自己会和那些喧嚣声一起沉寂下去，迎来死亡。直到醒来时，空气里有细小的水滴在闪烁——它们随着我的呼吸聚合又散开。</p>
   <p>我有了异能。但在这个世界上，异能者与感染者的界线几乎模糊不清，谁也不敢把这样的人放在身边。</p>
   <p>——但有一个人，仍然选择相信我。</p>`,

  `<p><span class='mutsumi-text'>若叶睦</span>。</p>
   <p>她一直在我身边。</p>
   <p>在拼死逃亡的夜里、在破旧的旅馆里，在我以为自己会熄灭的每一个瞬间，她都没有离开。</p>
   <p>她曾对我说：<span class='mutsumi-text'>“祥的眼睛还有光，你不会死的。”</span></p>`,

  `<p>可今天——</p>
   <p><i>（雷声炸响）</i> </p>
   <p>雨还在持续不断。外面的丧尸被雷声吸引，街巷里不断回荡着撕裂般的喊叫。</p>
   ...
   <p syyle="color:red">她的体温在下降，血色在她的脸上慢慢褪去。</p>`,

  `<p>——所以我做了个决定。</p>
   <p>我把她带进这栋废弃的房子，关上门，把她抱进怀里，不能让她被外人夺去。</p>
   <p>我会用我的异能去压制那股黑色病毒的蔓延，我要为睦争取时间。我相信——她能活下去。</p>
   <p>十四天。只要撑过这十四天，也许还能换来一个明天。</p>
   <p>——哪怕最后的代价，是我自己。</p>`,

  `<p>Oblivionis and Mortis</p>
...
const statsIntroTexts = [
  ...
  `<p><strong>物资</strong>：食物与零件等生存必需品，不足时将限制可选行动。</p>`,
...
const tutorialSteps = [
  ...
  `<p>每一天被分成五个时间段（早晨 / 中午 / 下午 / 傍晚 / 夜晚），每个时间段只能选择一项行动。<br>
   行动会消耗体力，也会影响心情、物资或感染值。请在行动间谨慎权衡。<br>
   <span class='mutsumi-text'><b>睦</b></span> 的感染会随着时间推进而加剧（每天+12),你们的心情也会随之减少（每天-10)。
...
const actions = {
    ...
    meal: {
        ...
        responses: {
            ...
            dinner: [
                ...
                "睦忽然夹起一块罐头递过来：“这是最后一块，给祥。” 你正要拒绝，她笑着说：“不许浪费。”",
    ...
    explore_alone: {
        ...
        responses: [
            ...
            "风很冷，吹乱你的发丝。你忽然意识到——已经很久没听见她的笑声了。",
    ...
    explore_withMutsumi: {
        ...
        responses: [
            ...
            "带回物资的路上，你忽然意识到——这种并肩的感觉，比安全更让人踏实。"
        ],
        cost: { stamina: 25 },
