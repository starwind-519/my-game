...
// 2. 和睦互动 - 统一归为 interaction 类
    ...
    // ===== 10 次 =====
    {
        ...
        "过了很久，她才开口。<br>" +
        "“祥……你总是陪在我身边。谢谢。”<br>" +
        "她的声音有点沙哑，却带着笑意。那一刻，你突然意识到——原来安静也可以这么温柔。",
        effect: () => {
...
treatMutsumi: [
  ...
  // ===== 12 次 =====
  {
    ...
    text:
      "你替<span class='mutsumi-text'>睦</span>包扎好伤口，她抬眼看向你。<br>" +
      "嘴角弯起一点笑：“祥真厉害，好像医生一样……”<br>" +
      "她的笑声轻，却带着一点颤。<br>" +
      "你忽然察觉，她的眼神深处，有一丝掩不住的惶恐。",
    effect: () => {
      gameState.love += 3;
      gameState.mutsumiMood += 2;
      gameState.sakikoMood += 1;
  ...
  // ===== 15次（带选项）=====
  {
    ...
    text:
      "夜色静得出奇。你再次调动异能，水流环绕着<span class='mutsumi-text'>睦</span>的伤口。<br>" +
...
meal: [
    ...
    // ===== 8 次（带选项）=====
    {
        condition: (count, state) => count === 8,
        text: "你找到一小包压缩饼干。<br>" +
        "正要分开时，<span class='mutsumi-text'>睦</span>从碗里夹出一片腌黄瓜，递到你面前：<br>" +
        "“祥，多吃点。”<br>" +
        "那片黄瓜泛着浅绿的光，像是仅存的柔软日常。",
        choices: [
            {
                text: "“睦更喜欢这个，自己留着吧。”",
                feedback: "她愣了一下，耳尖微红，最终还是轻轻咬下那片黄瓜。<br>" +
    ...
    // ===== 15 次（带选项）=====
    {
        ...
        "睦抿了一口，甜味淡得几乎尝不出来。<br>" +
        "她抬起眼，声音轻得像叹息：祥……要是以后真的什么都没有了，还能一起喝这个吗？”",
        choices: [
            {
                text: "“一定会有的。”",
...
rest_night: [
    ...
    // ===== 夜晚 10 次  =====
    {
        ...
        choices: [
            ...
            {
                text: "轻声安抚，摸了摸她的头",
                feedback: "你抬手按住她的肩，声音温和：“别怕，我在这。”<br>" +
