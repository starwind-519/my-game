...
const events = [
...

   {
        day: 4,
        type: "event",
        text: "凌晨时分，你被一阵细微却急促的喘息声惊醒。睦蜷缩在临时铺着毯子的角落，手臂处的伤口不断渗出浓稠的黑血，沿着手臂蜿蜒而下，仿佛有生命般蠕动，侵占着她的身体。她的体温烫得惊人，呼吸灼热而混乱。\n\n昨夜你明明替她包扎过，也用异能降温——但这一切似乎毫无意义。压制正在失效。那股你最畏惧的“失去感”，正悄然逼近。",
        options: [
            {
            text: "立刻寻找医疗用品、强行止血与降温",
            feedback: "你翻遍仅存的医疗用品，手指都因紧绷而发抖。纱布被黑血瞬间染透，你的动作越急，心越慌。睦抓住你的手，虚弱低语：“……冷静点，祥……” 但你听不进去。\n\n止血几乎无效，你只能不断更换敷料，祈求能拖延一点时间。",
            effects: { infection: +18, sakikoMood: -7, mutsumiMood: -4, supplies: -4, love: +3 }
            },
            {
            text: "使用水系异能进行净化与降温",
            feedback: "你深吸一口气，指尖凝出微凉的水光。你让水缓缓覆盖睦的伤口，试图带走那股暗色的死气。异能在持续输出中几乎失控，你的视线开始发白，耳鸣浮现。\n\n睦伸手抱住你，压住你的手腕：“祥……别再这样耗下去，会伤到你……” 她的声音因高热而颤抖，却依然在担心你。",
